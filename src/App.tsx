  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-headline">Welcome, {profile?.name}</h2>
          <p className="text-on-surface-variant">Manage your dental health and appointments.</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-surface-variant">
          ...
          <h3 className="font-bold text-lg mb-1">Health Status</h3>
          <p className="text-sm text-on-surface-variant">Clinical excellence verified.</p>
        </div>
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-surface-variant">
          <div className="w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center mb-4">
            <CreditCard className="w-6 h-6" />
          </div>
          <h3 className="font-bold text-lg mb-1">Outstanding Balance</h3>
          <p className="text-sm text-on-surface-variant">$0.00 (All clear)</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[32px] border border-surface-variant overflow-hidden">
        <div className="p-6 border-b border-surface-variant flex items-center justify-between">
          <h3 className="font-headline text-xl">Appointment History</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-start">
        ...
        <div className="bg-white p-10 rounded-[40px] shadow-xl border border-surface-variant">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? 'Processing...' : profile ? 'Request Appointment' : 'Sign in to Book'}
            </button>
          </form>
        </div>
      </div>
